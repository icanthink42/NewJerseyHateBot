        ...
        if message.content[0] == ">" or message.content[0] == ")":
            ...
            if message.content[0] == ">":
                ...
                if delta_time < config.song_skip_time:
                    await message.reply("You cannot replace the song for another " + str(math.floor((config.song_skip_time - delta_time) / 60)) + " minutes " + str(round((config.song_skip_time - delta_time) % 60, 2)) + " seconds!")
                    return
